...
<title>:: St John Medical Clinic - Hospital Admin ::</title>
...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>St John Medical Clinic </span>Login <span class="msg">Sign in to start your session</span></h1>
        <div class="col-md-12">
