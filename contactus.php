...
{  
	...
	sendmail("ngugidavid010@gmail.com","Mail from Appoint My Doctor",$message);
...
<div class="wrapper col4">
  <div id="container">
    <h6>Our Address</h6>
    <p>
St Johns Medical Clinic<br />

<strong>tel</strong>:0722473713<br />

<strong>Email ID</strong>: stjohnsclinic@gmail.com</p>
...
function sendmail($toaddress,$subject,$message)
{
	...
	$mail->Username = 'ngugidavid010@gmail.com';                 // SMTP username
	...
	$mail->addAddress($toaddress, 'User');     // Add a recipient
	$mail->addAddress($toaddress);               // Name is optional
	$mail->addReplyTo('ngugidavid', 'Information');
